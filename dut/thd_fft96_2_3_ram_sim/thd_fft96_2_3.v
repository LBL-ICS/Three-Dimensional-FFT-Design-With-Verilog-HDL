...
//parameter RDY_CY=100;            //ready signal on for 96x96x96 data input
//parameter OD_FFT_CY=10;            //1d fft input-output delay
...
parameter COUNTER_FN = 5*RDY_CY                ; //5*442368=2,211,840
