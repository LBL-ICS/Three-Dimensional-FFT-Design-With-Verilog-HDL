...
`elsif OD_FFT96_2_3               
od_fft96_2_3 u_od_fft96_2_3 (
`elsif OD_FFT96_4_6               
od_fft96_4_6 u_od_fft96_4_6 (
`elsif OD_FFT96_8_12               
od_fft96_8_12 u_od_fft96_8_12 (
`elsif OD_FFT96_16_24               
od_fft96_16_24 u_od_fft96_16_24 (
`elsif OD_FFT96_32_48               
od_fft96_32_48 u_od_fft96_32_48 (
`endif
                 .clock           (clock           ),
                 .reset           (reset           ),
...
reg check_fft_len6, check_fft_len12, check_fft_len18, check_fft_len32, check_fft_len36;
reg check_fft_len96;
...
check_fft_len27 = ((io_out_18_Re[31:16]<output_io_out[j+36][31:16]+16'h3) & (io_out_18_Re[31:16]>output_io_out[j+36][31:16]-16'h3)) &
                  ...
                  ((io_out_26_Im[31:16]<output_io_out[j+53][31:16]+16'h3) & (io_out_26_Im[31:16]>output_io_out[j+53][31:16]-16'h3)) ;
                    `ifdef FFT_ST_WT32
 check_fft_len32 = ((io_out_27_Re[31:16]<output_io_out[j+54][31:16]+16'h3) & (io_out_27_Re[31:16]>output_io_out[j+54][31:16]-16'h3)) &
                   ...
                   ((io_out_31_Im[31:16]<output_io_out[j+63][31:16]+16'h3) & (io_out_31_Im[31:16]>output_io_out[j+63][31:16]-16'h3)) ;
                    `ifdef FFT_ST_WT36
 check_fft_len36 = ((io_out_32_Re[31:16]<output_io_out[j+64][31:16]+16'h3) & (io_out_32_Re[31:16]>output_io_out[j+64][31:16]-16'h3)) &
...
`elsif FFT_ST_WT32
check_pass = check_fft_len2 & check_fft_len3 & check_fft_len4 & check_fft_len6 & check_fft_len8 & check_fft_len9 & check_fft_len12 & check_fft_len16 & check_fft_len18 & check_fft_len27 & check_fft_len32;
`elsif FFT_ST_WT36
check_pass = check_fft_len2 & check_fft_len3 & check_fft_len4 & check_fft_len6 & check_fft_len8 & check_fft_len9 & check_fft_len12 & check_fft_len16 & check_fft_len18 & check_fft_len27 & check_fft_len32 & check_fft_len36;
`elsif FFT_ST_WT96
check_pass = check_fft_len2 & check_fft_len3 & check_fft_len4 & check_fft_len6 & check_fft_len8 & check_fft_len9 & check_fft_len12 & check_fft_len16 & check_fft_len18 & check_fft_len27 & check_fft_len32 & check_fft_len36 & check_fft_len96;
`endif
